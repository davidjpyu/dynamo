...
class WorkerConfig:
    ...
    # The Rust Worker reads this for registration (Prefill → ModelType.Empty +
    # WorkerType.Prefill, Decode → disable local indexer); engines read it
    # from their own runtime config to switch per-mode protocol behavior in
    # `generate()`.
